...
/**
 * Represents a building which can be placed on the map - takes the building type (Halls, Library, Canteen or Bar) as a parameter.
 */
public class Building {
    ...
    public void render(SpriteBatch batch) {
        sprite.draw(batch); // renders the building
    }
